#api from the UPC database - Will Bohmann
#December 8, 2022
...
for _ in range(3):
    ...
    def upc():
        ...
        print("____________")
        print("Product: ",title, "", "Description:", description, "", "Category:", category, "", "Brand: ",brand, "", "Low Price: ",lowPrice, "", "High Price: ",highPrice, "--------", sep='\n')
